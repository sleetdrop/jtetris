...
the standalone jar, macOS Apple Silicon, macOS Intel, Windows 11 x64, and
Windows 11 arm64. On release tags, the workflow creates a draft GitHub Release
and uploads those assets for maintainer review. Users on unsupported native
platforms can run the standalone jar with Java 25.
