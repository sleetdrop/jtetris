...
final class HelpContent {
    ...
    static String helpHtml(UiTheme theme) {
        ...
        return """
                ...
                <p>The ghost piece shows where the active piece will land. The Next preview shows the upcoming piece. Hold stores one piece for later; after you use Hold, it is unavailable until the current piece locks.</p>
