...
JTetris MUST build release artifacts with GitHub Actions without automatically publishing a GitHub Release.
...
- **And** it uploads workflow artifacts for maintainer review and manual release attachment.
